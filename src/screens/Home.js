...
export default function Home() {
  ...
  // const handleHover = () => {
  //   document.getElementById("card").style.boxShadow = "10px 10px 10px #888888";
  // };
      ...
      {/* <div style={hm}>
        <div className="fortune-machine" style={srch}>
          ...
          <div>
            ...
            >
              Order good food from favourite restraunts near you
            </h5>
          </div>
          <div>
            ...
            <div style={{ fontSize: "1.2rem", textAlign: "center" }}>
              Search or <h7 style={{ color: "#ff7800" }}> swipe down </h7>to
              explore
            </div>
            <div
          ...
          <div style={{ marginBottom: "10px", padding: "0px 60px" }}>
            <h5>
              POPULAR CITIES IN INDIA <BiSolidCity />
            </h5>
          </div>
          <div style={{ marginBottom: "10px", padding: "0px 60px" }}>
            <h7> Delhi </h7>
            <h7 style={{ color: "#ff7800" }}> Mumbai </h7>
            <h7> Lucknow </h7>
            <h7 style={{ color: "#ff7800" }}> Kolkata </h7>
            <h7> Ahmedabad </h7>
            <h7 style={{ color: "#ff7800" }}> & more...</h7>
          </div>
        </div>
        <img
